...
$komputer = mysqli_query(
    $koneksi,
    "SELECT komputer.id_komputer, nama_komputer, nama_item FROM itemkom JOIN komputer ON itemkom.id_item=komputer.item_id WHERE id_komputer=$id"
);
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content" style="background-color: rgb(235,235,235);" >
                        ...
                        <form action="" method="post">
                            <input type="hidden" name="id_komputer" value="<?= $row[
                                'id_komputer'
                            ] ?>" >
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Komputer</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_komputer" name = "nama_komputer" value="<?= $row[
                                    'nama_komputer'
                                ] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <?php $itemkom = mysqli_query(
                                    $koneksi,
                                    'SELECT * FROM itemkom'
                                ); ?>
                                    <?php while (
                                        $row1 = mysqli_fetch_assoc($itemkom)
                                    ): ?>
                                    <option value="<?= $row1[
                                        'id_item'
                                    ] ?>"><?= $row1['nama_item'] ?></option>
                                    <?php endwhile; ?>
                                </select>
                                </div>
                            </div>
