...
$komputer = mysqli_query(
    $koneksi,
    "SELECT komputer.id_komputer, nama_komputer, nama, lab.id_lab FROM komputer JOIN lab ON komputer.id_komputer=lab.komputer_id WHERE id_lab=$id"
);
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content" style="background-color: rgb(235,235,235);" >
                        ...
                        <form action="" method="post">
                            <input type="hidden" name="id_lab" value="<?= $row[
                                'id_lab'
                            ] ?>" >
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Lab</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama" name = "nama" value="<?= $row[
                                    'nama'
                                ] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Nama Komputer</label>
                                <div class="col-sm-10">
                                <select style="width: 300px; height:40px;" name="nama_komputer">
                                <option> <?= $row['nama_komputer'] ?></option>
                                <?php $komputer = mysqli_query(
                                    $koneksi,
                                    'SELECT * FROM komputer'
                                ); ?>
                                    <?php while (
                                        $row1 = mysqli_fetch_assoc($komputer)
                                    ): ?>
                                    <option value="<?= $row1[
                                        'id_komputer'
                                    ] ?>"><?= $row1['nama_komputer'] ?></option>
                                    <?php endwhile; ?>
                                </select>
                                </div>
                            </div>
