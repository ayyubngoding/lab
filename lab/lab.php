...
$lab = mysqli_query(
    $koneksi,
    'SELECT nama_komputer,nama, lab.id_lab,komputer.id_komputer FROM komputer JOIN lab ON komputer.id_komputer=lab.komputer_id'
);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="id_lab">Id </label>
            <input type="text" class="form-control" id="id_lab" name="id_lab">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="nama_item">Nama Komputer</label>
            <select style="width: 200px;" name="nama_komputer">
         <option>pilih</option>
        <?php $komputer = mysqli_query($koneksi, 'SELECT * FROM komputer'); ?>
            <?php while ($row = mysqli_fetch_assoc($komputer)): ?>
            <option  value="<?= $row['id_komputer'] ?>"><?= $row[
    'nama_komputer'
] ?></option>
             <?php endwhile; ?>
        </select>
