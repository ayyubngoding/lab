...
$id = $_GET['ubah'];
$komputer = mysqli_query($koneksi, "SELECT * FROM itemkom WHERE id_item=$id");
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content" style="background-color: rgb(235,235,235);" >
                        ...
                        <form action="" method="post">
                            <input type="hidden" name="id_item" value="<?= $row[
                                'id_item'
                            ] ?>" >
                            <div class="form-group row">
                                <label for="nidn" class="col-sm-2 col-form-label">Nama_item</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_item" name = "nama_item" value="<?= $row[
                                    'nama_item'
                                ] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="quality" name = "quality" value="<?= $row[
                                    'quality'
                                ] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="status" name = "status" value="<?= $row[
                                    'status'
                                ] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" id="aksi" name = "aksi" value="<?= $row[
                                    'aksi'
                                ] ?>">
                                </div>
                            </div>
