<?php
require '../komputer/config.php';
$kondisi = mysqli_query(
    $koneksi,
    'SELECT nama_item,kondisi.id_kondisi,tanggal_perbaikan,kerusakan,penanganan,kebutuhan_komponen,hasil_perbaikan FROM itemkom JOIN kondisi on itemkom.id_item=kondisi.item_id'
);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="page-content" style="background-color: rgb(235,235,235);" >
                        ...
                        <div class="content-utama">
                          <table  class="table table-striped">
                            ...
                            <?php $i = 1; ?>
                            <?php while (
                                $row = mysqli_fetch_assoc($kondisi)
                            ): ?>
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $row['nama_item'] ?></td>
                                ...
                                <td><?= $row['kebutuhan_komponen'] ?></td>
                                <td><?= $row['hasil_perbaikan'] ?></td>
                                <td>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="nama">id kondisi</label>
            <input type="text" class="form-control" id="id_kondisi" name="id_kondisi">
        </div>
        <div class="form-group">
            ...
            <select style="width: 400px; height:40px;" name="nama_item" id="">
                ...
                <?php while ($row = mysqli_fetch_assoc($kondisi)): ?>
    ...
    'nama_item'
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="kebutuhan_komponen" name="kebutuhan_komponen">
        </div>
        <div class="form-group">
            <label for="hasil_perbaikan">Hasil Perbaikan</label>
            <input type="text" class="form-control" id="hasil_perbaikan" name="hasil_perbaikan">
        </div>
