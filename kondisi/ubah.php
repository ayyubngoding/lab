...
$komputer = mysqli_query(
    $koneksi,
    "SELECT nama_item,kondisi.id_kondisi,tanggal_perbaikan,kerusakan,penanganan,kebutuhan_komponen,hasil_perbaikan FROM itemkom JOIN kondisi on itemkom.id_item=kondisi.item_id WHERE id_kondisi=$id"
);
...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="form-group">
            <input type="hidden" class="form-control" id="id_kondisi" name="id_kondisi" value="<?= $row[
                'id_kondisi'
            ] ?>">
        </div>
        <div class="form-group">
            <label style="display: block;" for="nama">Nama Item</label>
            <select style="width: 400px; height:40px;" name="nama_item" id="">
                <option ><?= $row['nama_item'] ?></option>
                <?php $kondisi = mysqli_query(
                    $koneksi,
                    'SELECT * FROM itemkom'
                ); ?>
                <?php while ($row1 = mysqli_fetch_assoc($kondisi)): ?>
                    <option value="<?= $row1['id_item'] ?>"><?= $row1[
    'nama_item'
] ?></option>
                    <?php endwhile; ?>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="tanggal_perbaikan" name="tanggal_perbaikan"
             value="<?= $row['tanggal_perbaikan'] ?>">
        </div>
        <div class="form-group">
            <label for="kerusakan">Kerusakan</label>
            <input type="text" class="form-control" id="kerusakan" name="kerusakan" value="<?= $row[
                'kerusakan'
            ] ?>">
        </div>
        <div class="form-group">
            <label for="penanganan">Penanganan</label>
            <select style="width: 400px; height:40px;" name="penanganan" id="">
            <option ><?= $row['penanganan'] ?></option>
                <option value="Service">service</option>
                <option value="beli baru">Beli baru</option>
            </select>
        </div>
        <div class="form-group">
            <label for="kebutuhan_komponen">Kebutuhan Komponen</label>
            <input type="text" class="form-control" id="kebutuhan_komponen" name="kebutuhan_komponen"value="<?= $row[
                'kebutuhan_komponen'
            ] ?>">
        </div>
        <div class="form-group">
            <label for="hasil_perbaikan">Hasil Perbaikan</label>
            <input type="text" class="form-control" id="hasil_perbaikan" name="hasil_perbaikan" value="<?= $row[
                'hasil_perbaikan'
            ] ?>">
        </div>
